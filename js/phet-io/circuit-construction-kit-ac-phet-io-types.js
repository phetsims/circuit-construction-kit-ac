...
window.phet.phetio.phetioTypes = assert &&
  {
    ...
    "EnumerationIO(ELECTRONS|CONVENTIONAL)": {
      ...
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(ELECTRONS|CONVENTIONAL)"
    },
    "EnumerationIO(EXPLORE|TEST)": {
      "documentation": "Possible values: EXPLORE,TEST.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(EXPLORE|TEST)"
    },
    "EnumerationIO(LIFELIKE|SCHEMATIC)": {
      "documentation": "Possible values: LIFELIKE,SCHEMATIC.",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "supertype": "ObjectIO",
      "typeName": "EnumerationIO(LIFELIKE|SCHEMATIC)"
    },
    "EventIO": {
    ...
    "FunctionIO(EnumerationIO(ELECTRONS|CONVENTIONAL),NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(ELECTRONS|CONVENTIONAL), NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(ELECTRONS|CONVENTIONAL)",
        "NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(ELECTRONS|CONVENTIONAL),NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>)=>VoidIO"
    },
    "FunctionIO(EnumerationIO(EXPLORE|TEST),NullableIO<EnumerationIO(EXPLORE|TEST)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(EXPLORE|TEST), NullableIO<EnumerationIO(EXPLORE|TEST)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(EXPLORE|TEST)",
        "NullableIO<EnumerationIO(EXPLORE|TEST)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(EXPLORE|TEST),NullableIO<EnumerationIO(EXPLORE|TEST)>)=>VoidIO"
    },
    "FunctionIO(EnumerationIO(LIFELIKE|SCHEMATIC),NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)>)=>VoidIO": {
      "documentation": "Wrapper for the built-in JS function type.<br><strong>Arguments:</strong> EnumerationIO(LIFELIKE|SCHEMATIC), NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)><br><strong>Return Type:</strong> VoidIO",
      "events": [],
      "methodOrder": [],
      "methods": {},
      "parameterTypes": [
        "EnumerationIO(LIFELIKE|SCHEMATIC)",
        "NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)>",
        "VoidIO"
      ],
      "supertype": "ObjectIO",
      "typeName": "FunctionIO(EnumerationIO(LIFELIKE|SCHEMATIC),NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)>)=>VoidIO"
    },
    ...
    "NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>": {
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>"
    },
    "NullableIO<EnumerationIO(EXPLORE|TEST)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(EXPLORE|TEST)>"
    },
    "NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
      ...
      "supertype": "ObjectIO",
      "typeName": "NullableIO<EnumerationIO(LIFELIKE|SCHEMATIC)>"
    },
    "NullableIO<FocusIO>": {
      "documentation": "A wrapper to wrap another IOType, adding support for null.",
      "events": [],
    ...
    "PropertyIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(ELECTRONS|CONVENTIONAL)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(ELECTRONS|CONVENTIONAL)>"
    },
    "PropertyIO<EnumerationIO(EXPLORE|TEST)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(EXPLORE|TEST)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(EXPLORE|TEST)>"
    },
    "PropertyIO<EnumerationIO(LIFELIKE|SCHEMATIC)>": {
      "documentation": "Observable values that send out notifications when the value changes. This differs from the traditional listener pattern in that added listeners also receive a callback with the current value when the listeners are registered. This is a widely-used pattern in PhET-iO simulations.",
      "events": [
        "changed"
      ],
      ...
      "methods": {
        "getValue": {
          "documentation": "Gets the current value.",
          "parameterTypes": [],
          "returnType": "EnumerationIO(LIFELIKE|SCHEMATIC)"
        },
        "lazyLink": {
          "documentation": "Adds a listener which will be called when the value changes. This method is like \"link\", but without the current-value callback on registration. The listener takes two arguments, the new value and the previous value.",
          "parameterTypes": [
      ...
      "supertype": "ObjectIO",
      "typeName": "PropertyIO<EnumerationIO(LIFELIKE|SCHEMATIC)>"
    },
