 ...
 * please modify circuit-construction-kit-ac/package.json to control dependencies.
 *
 * RequireJS configuration file for the circuit-construction-kit-ac sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'circuit-construction-kit-ac-main' ],
